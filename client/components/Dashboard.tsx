...
//   // Temporarily replace Dashboard import with a simple component for testing
          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex-shrink-0 flex items-center">
              <span className="text-2xl font-medium font-poppins">
                ...
                <span className="text-red-500">मित्र</span>
              </span>
            </div>
            ...
            {/* User dropdown */}
            <div className="hidden md:ml-4 md:flex md:items-center md:space-x-4">
              <button className="p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600">
                <span className="sr-only">View notifications</span>
                <Bell className="h-6 w-6" />
              </button>
              ...
              <div className="relative flex items-center">
                ...
                <button
                  onClick={onLogout}
                  className="ml-2 p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600"
                >
                  <LogOut className="h-5 w-5" />
                </button>
              </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="overflow-hidden shadow-md">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  {recommendedInternships.map((internship) => (
                    <Card key={internship.id} className="overflow-hidden border border-gray-200 hover:border-blue-600 transition-colors">
                      <div className="p-4">
                        <div className="flex justify-between items-start">
                          <div>
                            <h4 className="text-sm font-medium text-gray-900">{internship.position}</h4>
                ...
                <div className="mt-6 text-center">
                  <Button variant="link" className="text-blue-600 hover:text-blue-700 inline-flex items-center">
                    View all internships
                    <ChevronRight className="ml-1 h-4 w-4" />
                  </Button>
                </div>
